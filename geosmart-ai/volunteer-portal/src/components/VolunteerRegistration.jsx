...
const VolunteerRegistration = ({ onComplete }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.warn("API failed, proceeding with mock registration for hackathon demo");
    } finally {
      setIsSuccess(true);
      setTimeout(() => {
        onComplete(payload);
  ...
  return (
    <div className="max-w-md mx-auto glass-card p-8 border-white/10 relative z-10 shadow-2xl">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h2 className="text-2xl font-bold">Join the Force</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
        ...
        <div className="p-4 bg-primary/5 rounded-xl border border-primary/10 flex gap-3">
          ...
          <p className="text-[10px] text-gray-400">
            By registering, you agree to be available for emergency missions within a 10km radius.
          </p>
        </div>
